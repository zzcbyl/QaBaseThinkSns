...
/**
 * 微博列表
 * @example {:W('UserEducationInfo',array('mid'=>$mid, 'uid'=>$uid))}
 * @author jason
 * @version TS3.0
 */
class UserEducationInfoWidget extends Widget {
	...
	public function render($data) {
		...
		$ProfessionList['enterYear']=$year;

		$ProfessionList['mid']=$mid;
		$ProfessionList['uid']=$uid;
		// 渲染模版
		$content = $this->renderFile(dirname(__FILE__)."/educationinfo.html", $ProfessionList);
		// 输出数据
		return $content;
	}
