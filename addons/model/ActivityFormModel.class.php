...
class ActivityFormModel extends Model {
	...
	protected $fields = array('activity_form_id','childname','childage','childsex','childheight','childminzu','parentsname1','parentsex1','parentheight1','parentminzu1','parentsmobile1','parentsemail1','parentsname2','parentsex2','parentheight2','parentminzu2','parentsmobile2','parentsemail2','istogether','remarks','ctime','activityname','orderID','ispay','paytotal','paytime','paysuccesstime','location','_pk'=>'activity_form_id');
