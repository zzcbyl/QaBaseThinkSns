...
M.addEventFns({
    ...
    post_feed: {	//发布普通|图片提问 
        click: function () {
            ...
            //alert($(inviteObj).find('input').get(6).value);
            //return;
    ...
    post_feed_box: {
        click: function () {
            ...
            var mini_editor = this.parentModel.parentModel.childModels['mini_editor'][0];
            var textarea = $(mini_editor).find('textarea').get(0);
            core.weibo_mobile.post_feed(_this, mini_editor, textarea, true);
        }
    },
    post_submission_box: {
        click: function () {
            ...
            var mini_editor = this.parentModel.parentModel.childModels['mini_editor'][0];
            var textarea = $(mini_editor).find('textarea').get(0);
            core.weibo_mobile.post_feed(_this, mini_editor, textarea, true, 'submission');
        }
    },
    insert_at: {
        click: function () {
    ...
    insert_topic: {
        click: function () {
            ...
            core.weibo_mobile.checkNums(textArea);
            return false;
        }
    },
    /**
    ...
    */
    ...
    loadPost: {
        click: function () {
            ...
            $.post(U('widget/FeedListMobile/getPostDetail'), { post_id: attrs.post_id }, function (res) {
                html = '';
            ...
            if ($(this).attr('texttype') == undefined || $(this).attr('texttype') == "") {
                if (!this.ready) {
                    ...
                    var checknums = function () {
                        core.weibo_mobile.checkNums(_this);
                    };
                    ...
                    if ("undefined" != typeof (args.t)) {
                        ...
                        switch (args.t) {
                            ...
                            case 'feed':
                                ...
                                core.weibo_mobile.post_feed(postObj, this.parentModel, _this);
                                break;
                            case 'repostweibo':
