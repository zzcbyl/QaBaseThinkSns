    ...
    */
    ...
    comment: {
        click: function () {	//点击评论的时候
            ...
            //			if("undefined" == typeof(core.comment_mobile)){
            //				core.plugInit('comment',attrs,comment_list);
            //				core.setTimeout("core.comment_mobile.display()",150);
            //			}else{
            //alert('3333');
            core.comment_mobile.init(attrs, comment_list);
            core.comment_mobile.display();
            //			}
            return false;
        }
    },
    reply_comment: {	//点某条回复
        click: function () {
            ...
            core.plugFunc('comment', function () {
                core.comment_mobile.init(attrs, comment_list);
                core.comment_mobile.initReply();
            });
            //core.plugInit('comment',attrs,comment_list);
            //core.setTimeout("core.comment_mobile.initReply()",150);
        }
    },
    comment_del: {
        click: function () {
            ...
            if ("undefined" == typeof (core.comment_mobile)) {
                core.plugFunc('comment', function () {
                    core.comment_mobile.delComment(attrs.comment_id);
                });
            } else {
                core.comment_mobile.delComment(attrs.comment_id);
            }
    ...
    do_comment: {	//回复操作
        click: function () {
            ...
            core.comment_mobile.addComment(after, this);
            this.noreply = 1;
            setTimeout(function () {
                _this.noreply = 0;
            }, 3000);
