            ...
            success: function (txt) {
                ...
                if (1 == txt.status) {
                    ...
                    M.getJS(THEME_URL + "/js/imgareaselect/jquery.imgareaselect.min.js", function () {
                        ...
                        area.innerHTML = "<img width=200 src=\"" + txt.data["fullpicurl"] + "?t=" + tmpDate.getTime() + "\" />";
                        //$(area).hide();
                        //preview.innerHTML = "<img width=200 src=\"" + txt.data["fullpicurl"] + "?t=" + tmpDate.getTime() + "\" />";
                        $(preview).hide();
                ...
                if (1 == txt.status) {
                    ...
                    while (l-- > 0) {
                        switch (scanImg[l].size) {
                            case "big":
                                scanImg[l].img.src = txt.data.original + "?t=" + time;
                                break;
                            case "middle":
