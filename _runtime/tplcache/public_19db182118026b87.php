...
<link href="__APP__/login.css" rel="stylesheet" type="text/css" />
    <div id="page-wrap">
		<div class="reg-wrap">
			<!--<div class="title"><?php echo L('PUBLIC_UPLOAD_IMAGE');?></div>-->
			<div class="reg-main">
				<!--注册步骤-->
				<div class="article article-avatar boxShadow">
					<div class="item-step2">
						<div class="step">
							<span class="step1 step1-current"></span><span class="step2"></span><span class="step3"></span>
						</div>
					 <?php echo W('Avatar',array('avatar'=>$user_info,'defaultImg'=>$user_info['avatar_big'],'callback'=>'nextStep'));?>
                     <?php if(!$need_photo){ ?><a class="btn-green-small" href="javascript:void(0);" onclick="nextStep();"><?php echo L('PUBLIC_BACKUP');?></a><?php } ?>
				</div>
...
<script type="text/javascript">
    var nextStep = function(){
    	var tag_open = '<?php echo ($tag_open); ?>';
    	var interester_open = '<?php echo ($interester_open); ?>';
    	if((tag_open==0) && (interester_open==0)){
    			location.href = "<?php echo U('public/Register/doStep4') ?>";
    	}else{
    		if(tag_open==1){
    			location.href = "<?php echo U('public/Register/step3'); ?>";
    		}else{
    			location.href = "<?php echo U('public/Register/step4'); ?>";
    		}
    	}  
    };
</script>
