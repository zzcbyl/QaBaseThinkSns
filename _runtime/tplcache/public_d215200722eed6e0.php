                    ...
                    <table style="line-height:35px;">
				       <tr>
				        ...
				        <tr>
				            ...
				            <td><textarea style="width:600px; height:78px;  font-size: 14px; padding:5px; background: none repeat scroll 0 0 #FFFFFF; border: 1px solid #DDDDDD; box-shadow: 1px 1px 3px #DCDCDC inset;" ></textarea></td>
				        </tr>
				    </table>					
