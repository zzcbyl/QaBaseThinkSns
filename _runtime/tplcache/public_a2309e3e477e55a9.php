...
<?php if(is_array($data)): ?><?php $i = 0;?><?php $__LIST__ = $data?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vl): ?><?php ++$i;?><?php $mod = ($i % 2 )?><?php $cancomment_old = empty($vl['app_row_id'])  ? 0 : 1; ?>
    ...
    <table width="589px" style="line-height:22px;">
	    <tr>
	        ...
	        <td style="width:539px; display:block;"><a href="<?php echo U('public/Profile/feed',array('feed_id'=>$vl['feed_id'],'uid'=>$vl['uid']));?>"><span class="contents"><?php echo (format($vl["body"],true)); ?></span></a></td>
	    </tr>
	    <tr>
	        <td style="width:50px; text-align:right; vertical-align:top;">描述：</td>
	        <td style="width:539px; display:block;"><span class="contents"><?php echo (format($vl["description"],true)); ?></span></td>
	    </tr>
	</table>
